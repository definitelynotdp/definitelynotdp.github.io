  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Debasish Padhiary",
          from_email: form.email,
          to_email: "padhiarydebasish@gmail.com",
      ...
      .then(
        () => {
          ...
          showAlert({
            show: true,
            text: "Gratitude for thy missive, traveler!",
            type: "success",
          });
        ...
        (error) => {
          ...
          showAlert({
            show: true,
            text: "The winds have swallowed thy words… resend, noble scribe!",
            type: "danger",
          });
        }
      );
        ...
        <h1 className='head-text'>Get in Touch</h1>
          ...
          >
              ...
              <button
                  ...
                  onBlur={handleBlur}
              >
                  {loading ? "Sending via Raven..." : "Deliver Scroll"}
              </button>
          </form>
      </div>
